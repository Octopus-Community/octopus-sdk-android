package com.octopuscommunity.sample.sso.octopusprofile.data

import android.util.Base64
import com.octopuscommunity.sample.sso.octopusprofile.BuildConfig
...
object TokenProvider {
    ...
    fun getToken(userId: String): String {
        ...
        // In your app, you should probably call a backend route that provides you this token
        val secret = BuildConfig.CLIENT_USER_TOKEN_SECRET
